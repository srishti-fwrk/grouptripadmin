...
class TripsController extends AppController {
    ...
    public function beforeFilter() {
        ...
        $this->Auth->allow('api_tripadd', 'api_upcomingtrip', 'admin_edit', 'api_singletrip', 'admin_tripgallery','admin_view','admin_deleteimage',
                'api_edittrip','api_tripimage','api_pasttrip','api_tripcount','api_step1','api_step2','api_step3','api_step4','api_step5','api_step6','api_writefile');
    }
...
public function api_pasttrip(){
    if($this->request->is('post')){
        ...
        if($user_id){
          $data = $this->Trip->find('all',array('conditions'=>array('Trip.user_id'=>$user_id)));
